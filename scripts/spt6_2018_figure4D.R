...
main = function(theme_spec,
    ...
    netseq_plot = ggplot(data = netseq_df %>%
        ...
        theme_heatmap +
        theme(strip.text = element_text(size=9, color="black", face="plain"),
    ...
    mnase_plot = ggplot(data = mnase_df %>%
        ...
        facet_grid(.~group, labeller=label_parsed) +
        theme_heatmap +
        theme(strip.text = element_text(size=9, color="black", face="plain", margin=margin(0,0,0,0,"pt")),
              panel.grid.major.x = element_line(color="black"),
    ...
    fuzz_plot = ggplot(data = quant_df %>%
        ...
        theme_heatmap +
        theme(strip.text = element_text(size=6, color="black", face="plain", margin=margin(0,0,0,0,"pt")))
    ...
    fig_four_d = plot_grid(netseq_plot, mnase_plot, occ_plot, fuzz_plot, align="h", axis="tb", nrow=1,
