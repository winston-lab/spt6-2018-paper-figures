...
main = function(theme_spec, seq_data_path, qpcr_data_path,
    ...
    fig_two_d = plot_grid(seq_plot, diagram, qpcr_plot, ncol=1, align="v", axis="lr", rel_heights = c(1,0.15,1)) %>%
        add_label("D")
    ...
    ggplot2::ggsave(svg_out, plot=fig_two_d, width=fig_width, height=fig_height, units="cm")
    ggplot2::ggsave(pdf_out, plot=fig_two_d, width=fig_width, height=fig_height, units="cm")
    ggplot2::ggsave(png_out, plot=fig_two_d, width=fig_width, height=fig_height, units="cm", dpi=326)
