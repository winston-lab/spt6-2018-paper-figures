...
main = function(theme_spec, 
    ...
    fig_two_e = arrangeGrob(tss_plot, tfiib_plot, ncol=1, heights = c(1, 1)) %>%
        add_label("E")
    
    ggsave(svg_out, plot=fig_two_e, width=fig_width, height=fig_height, units="cm")
    ggsave(pdf_out, plot=fig_two_e, width=fig_width, height=fig_height, units="cm")
    ggsave(png_out, plot=fig_two_e, width=fig_width, height=fig_height, units="cm", dpi=326)
    save(fig_two_e, file=grob_out)
}
