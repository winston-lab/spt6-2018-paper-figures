...
main = function(supp_one_a, supp_one_b, supp_one_c, supp_one_d, supp_one_e,
    ...
    layout = rbind(c(1,1,1,1,1,1,1,1,2,2,2,2),
                   c(1,1,1,1,1,1,1,1,2,2,2,2),
                   c(1,1,1,1,1,1,1,1,2,2,2,2),
                   c(1,1,1,1,1,1,1,1,NA,NA,NA,NA),
                   c(3,3,3,3,3,3,NA,4,4,4,4,4),
                   c(3,3,3,3,3,3,NA,4,4,4,4,4),
                   c(3,3,3,3,3,3,NA,4,4,4,4,4),
                   c(3,3,3,3,3,3,NA,4,4,4,4,4),
                   c(5,5,5,5,5,5,NA,NA,NA,NA,NA,NA),
                   c(5,5,5,5,5,5,NA,NA,NA,NA,NA,NA),
                   c(5,5,5,5,5,5,NA,NA,NA,NA,NA,NA),
                   c(5,5,5,5,5,5,NA,NA,NA,NA,NA,NA))
    ...
    supp_one = arrangeGrob(supp_one_a, supp_one_b, supp_one_c, supp_one_d, supp_one_e,
