...
rule all:
    input:
        "figure1/figure1A/spt6_2018_figure1A-TSS-seq-heatmaps-all.png",
        "figure1/figure1A/spt6_2018_figure1A-TSS-seq-heatmaps-nonoverlapping.png",
        ...
        # "figure2/figure2A/spt6_2018_figure2A-TFIIB-ChIPnexus-heatmaps-all.png",
        # "figure2/figure2A/spt6_2018_figure2A-TFIIB-ChIPnexus-heatmaps-nonoverlapping.png",
